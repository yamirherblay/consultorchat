package com.consultor.application.views.chatconsulta;
...
@PageTitle("Chat Consulta")
@Route(value = "chat-consulta", layout = MainLayout.class)
@RolesAllowed("ADMIN")
public class ChatConsultaView extends HorizontalLayout {
    ...
    public ChatConsultaView() {
        addClassNames("chat-consulta-view", Width.FULL, Display.FLEX, Flex.AUTO);
        setSpacing(false);
