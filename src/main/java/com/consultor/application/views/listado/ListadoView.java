package com.consultor.application.views.listado;

import com.consultor.application.data.entity.SampleBook;
import com.consultor.application.data.service.SampleBookService;
import com.consultor.application.views.MainLayout;
...
@PageTitle("Listado")
@Route(value = "Listado/:sampleBookID?/:action?(edit)", layout = MainLayout.class)
@PermitAll
public class ListadoView extends Div implements BeforeEnterObserver {

    private final String SAMPLEBOOK_ID = "sampleBookID";
    private final String SAMPLEBOOK_EDIT_ROUTE_TEMPLATE = "Listado/%s/edit";
    ...
    public ListadoView(SampleBookService sampleBookService) {
        ...
        grid.asSingleSelect().addValueChangeListener(event -> {
            if (event.getValue() != null) {
                ...
                clearForm();
                UI.getCurrent().navigate(ListadoView.class);
            }
        });
    ...
    public void beforeEnter(BeforeEnterEvent event) {
        ...
        if (sampleBookId.isPresent()) {
            ...
            if (sampleBookFromBackend.isPresent()) {
                ...
                // refresh grid
                refreshGrid();
                event.forwardTo(ListadoView.class);
            }
        }
    }
