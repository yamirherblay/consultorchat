package com.consultor.application.views.collaborativemasterdetail;

import com.consultor.application.data.entity.SampleAddress;
import com.consultor.application.data.service.SampleAddressService;
...
@Route(value = "collaborative-master-detail/:sampleAddressID?/:action?(edit)", layout = MainLayout.class)
@RolesAllowed("USER")
public class CollaborativeMasterDetailView extends Div implements BeforeEnterObserver {
    ...
    private final String SAMPLEADDRESS_EDIT_ROUTE_TEMPLATE = "collaborative-master-detail/%s/edit";
    ...
    public CollaborativeMasterDetailView(SampleAddressService sampleAddressService) {
